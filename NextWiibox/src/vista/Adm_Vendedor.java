 ...
 * @author HP Desktop
 */
public class Adm_Vendedor extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel_Acceder.setText("Ingresar Vendedor");
        ...
        vendedor.add(jPanel_ingresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 122, -1, -1));
        ...
        jLabel_Acceder1.setText("Actualizar Vendedor");
        ...
        vendedor.add(jPanel_actualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 212, -1, -1));
        ...
        jLabel_Acceder2.setText("Eliminar Vendedor");
        ...
        vendedor.add(jPanel_eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 302, -1, -1));
        ...
        vendedor.add(jPanel_cerrar_sesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 392, 200, -1));
        ...
        jLabel_Titulo.setText("VENDEDOR");
        vendedor.add(jLabel_Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 56, 200, -1));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(vendedor, javax.swing.GroupLayout.DEFAULT_SIZE, 660, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 460, Short.MAX_VALUE)
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(vendedor, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE))
        );
    ...
    private void jLabel_AccederMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_AccederMouseClicked
        ...
        vendedor.removeAll();
        vendedor.add(ingresarArriendo,new org.netbeans.lib.awtextra.AbsoluteConstraints(0,0,-1,-1));
        vendedor.revalidate();
        vendedor.repaint();
    ...
    private void jLabel_Acceder1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_Acceder1MouseClicked
        ...
        vendedor.removeAll();
        vendedor.add(actualizarUsuario,new org.netbeans.lib.awtextra.AbsoluteConstraints(0,0,-1,-1));
        vendedor.revalidate();
        vendedor.repaint();
    ...
    private void jLabel_Acceder2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_Acceder2MouseClicked
        ...
        vendedor.removeAll();
        vendedor.add(eliminarArriendo,new org.netbeans.lib.awtextra.AbsoluteConstraints(0,0,-1,-1));
        vendedor.revalidate();
        vendedor.repaint();
    ...
    private void jLabel_Acceder3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_Acceder3MouseClicked
        ...
        vendedor.removeAll();
        vendedor.add(login,new org.netbeans.lib.awtextra.AbsoluteConstraints(0,0,-1,-1));
        vendedor.revalidate();
        vendedor.repaint();
